...
<header class="sticky top-0 z-30 flex items-center justify-between border-b border-cream bg-cream/90 px-4 py-4 backdrop-blur sm:px-6 lg:px-8">
    <div class="flex items-center gap-3">
        <button id="sidebar-toggle" class="flex h-10 w-10 items-center justify-center rounded-xl bg-white text-espresso shadow-soft lg:hidden" aria-label="Toggle menu" aria-expanded="false">
